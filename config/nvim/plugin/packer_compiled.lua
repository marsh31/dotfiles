...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-buffer', 'cmp-cmdline', 'cmp-nvim-lua', 'cmp-path', 'cmp_luasnip', 'cmp-nvim-lsp-signature-help', 'cmp-nvim-lsp-document-symbol'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
