...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-buffer', 'cmp-cmdline', 'cmp-nvim-lsp-document-symbol', 'cmp-nvim-lsp-signature-help', 'cmp-path', 'cmp_luasnip', 'cmp-nvim-lua'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
