...
_G.packer_plugins = {
  ...
  ["nvim-surround"] = {
    config = { "\27LJ\2\nﬁ\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\2B\0\2\1K\0\1\0\fkeymaps\1\0\0\1\0\n\16visual_line\agS\20normal_cur_line\bsAS\16normal_line\asA\15normal_cur\bsas\vnormal\asa\vvisual\6S\16insert_line\v<C-g>S\vchange\asc\vinsert\v<C-g>s\vdelete\asd\nsetup\18nvim-surround\frequire\0" },
    loaded = true,
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-buffer', 'cmp-nvim-lsp-document-symbol', 'cmp-path', 'cmp_luasnip', 'cmp-cmdline', 'cmp-nvim-lsp-signature-help', 'cmp-nvim-lua'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
