...
_G.packer_plugins = {
  ...
  ["nvim-surround"] = {
    config = { "\27LJ\2\nﬁ\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\2B\0\2\1K\0\1\0\fkeymaps\1\0\0\1\0\n\vvisual\6S\vnormal\asa\vinsert\v<C-g>s\16visual_line\agS\16insert_line\v<C-g>S\vchange\asc\vdelete\asd\20normal_cur_line\bsAS\16normal_line\asA\15normal_cur\bsas\nsetup\18nvim-surround\frequire\0" },
    loaded = true,
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-path', 'cmp_luasnip', 'cmp-nvim-lua', 'cmp-buffer', 'cmp-cmdline', 'cmp-nvim-lsp-document-symbol', 'cmp-nvim-lsp-signature-help'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
