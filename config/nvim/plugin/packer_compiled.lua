...
_G.packer_plugins = {
  ...
  ["vim-illuminate"] = {
    loaded = true,
    path = "/home/marsh/.local/share/nvim/site/pack/packer/start/vim-illuminate",
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-buffer', 'cmp-cmdline', 'cmp-nvim-lsp-document-symbol', 'cmp-nvim-lsp-signature-help', 'cmp-nvim-lua', 'cmp_luasnip', 'cmp-path'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
